...
/**
 * @title YesToken
 * @notice ERC20 token representing YES outcome for a song market
 */
contract YesToken is ERC20, ERC20Burnable {
    ...
    constructor(uint256 _songId) ERC20(
        string.concat("Song ", _toString(_songId), " YES"),
        string.concat("HYES-", _toString(_songId))
    ) {
        market = msg.sender;
        songId = _songId;
    }
